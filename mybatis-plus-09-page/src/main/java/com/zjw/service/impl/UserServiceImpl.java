...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public void decuctBalance(Long id, Integer money) {
        ...
        //校验用户状态
        if (Objects.isNull(user) || user.getStatus() == UserEnum.Status.FREEZE) {
        ...
        lambdaUpdate()
                ...
                .set(remain == 0, User::getStatus, UserEnum.Status.FREEZE)//用户没钱，账户设为冻结
                .eq(User::getId, id)
...
//        }
        ...
        //查询
        page = lambdaQuery()
                .like(Objects.nonNull(query.getName()), User::getUsername, query.getName())
                .eq(Objects.nonNull(query.getStatus()), User::getStatus, query.getStatus())
                .ge(Objects.nonNull(query.getMinBalance()), User::getBalance, query.getMinBalance())
                .le(Objects.nonNull(query.getMaxBalance()), User::getBalance, query.getMaxBalance())
                .page(page);
        //返回
